...
// GetAllResourceInfoOfGcpAwsVpn godoc
// @Summary Get all resource info to configure GCP to AWS VPN tunnels
// @Description Get all resource info to configure GCP to AWS VPN tunnels
// @Tags [VPN] GCP to AWS VPN tunnel configuration
// @Accept  json
// @Produce  json
// @Param resourceGroupId path string true "Resource group ID" default(tofu-rg-01)
...
// @Failure 400 {object} models.ResponseText "Bad Request"
// @Failure 503 {object} models.ResponseText "Service Unavailable"
// @Router /rg/{resourceGroupId}/vpn/gcp-aws/resource/info [get]
...
// GetAllResourceIdOfGcpAwsVpn godoc
// @Summary Get all resource IDs to configure GCP to AWS VPN tunnels
// @Description Get all resource IDs to configure GCP to AWS VPN tunnels
// @Tags [VPN] GCP to AWS VPN tunnel configuration
// @Accept  json
// @Produce  json
// @Param resourceGroupId path string true "Resource group ID" default(tofu-rg-01)
...
// @Failure 400 {object} models.ResponseText "Bad Request"
// @Failure 503 {object} models.ResponseText "Service Unavailable"
// @Router /rg/{resourceGroupId}/vpn/gcp-aws/resource/id [get]
...
func CreateBlueprintOfGcpAwsVpn(c echo.Context) error {
	...
	res := models.ResponseText{Success: true, Text: "Successfully created a blueprint to configure GCP to AWS VPN tunnels"}
...
func CreateGcpAwsVpn(c echo.Context) error {
	...
	if err != nil {
		res := models.ResponseText{Success: false, Text: "Failed to deploy network resources to configure GCP to AWS VPN tunnels"}
		return c.JSON(http.StatusInternalServerError, res)
	}
	res := models.ResponseText{Success: true, Text: ret}
