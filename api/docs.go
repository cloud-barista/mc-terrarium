...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/tr/{trId}/vpn/star-vpn": {
            "get": {
                "description": "Get resource info to configure a star VPN",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "tags": [
                    "[VPN] Star VPN configuration"
                ],
                "summary": "Get resource info to configure a star VPN",
                "parameters": [
                    {
                        "type": "string",
                        "default": "tr01",
            ...
            "post": {
                "description": "Create network resources for a star VPN",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "summary": "Create network resources for a star VPN",
                "parameters": [
                    {
                        "type": "string",
                        "default": "tr01",
            ...
            "delete": {
                "description": "Destroy network resources that were used to configure a star VPN",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "summary": "Destroy network resources that were used to configure a star VPN",
                "parameters": [
                    {
                        "type": "string",
                        "default": "tr01",
        ...
        "/tr/{trId}/vpn/star-vpn/env": {
            "post": {
                "description": "Initialize a multi-cloud terrarium for a star VPN",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "summary": "Initialize a multi-cloud terrarium for a star VPN",
                "parameters": [
                    {
                        "type": "string",
                        "default": "tr01",
        ...
        "/tr/{trId}/vpn/star-vpn/infracode": {
            "post": {
                "description": "Create the infracode to configure a star VPN",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "summary": "Create the infracode to configure a star VPN",
                "parameters": [
                    {
                        "type": "string",
                        "default": "tr01",
                    ...
                    {
                        "description": "Parameters requied to create the infracode to configure a star VPN",
                        "name": "ParamsForInfracode",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.CreateInfracodeOfStarVpnRequest"
                        }
                    },
                    {
                        "type": "string",
        ...
        "/tr/{trId}/vpn/star-vpn/plan": {
            "post": {
                "description": "Check and show changes by the current infracode to configure a star VPN",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "summary": "Check and show changes by the current infracode to configure a star VPN",
                "parameters": [
                    {
                        "type": "string",
                        "default": "tr01",
        ...
        "/tr/{trId}/vpn/star-vpn/request/{requestId}": {
            "get": {
                "description": "Check the status of a specific request by its ID",
                "consumes": [
                    "application/json"
    ...
    "definitions": {
        ...
        "model.CreateInfracodeOfStarVpnRequest": {
            "type": "object"
        },
